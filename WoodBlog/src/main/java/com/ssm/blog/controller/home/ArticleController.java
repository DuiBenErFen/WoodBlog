package com.ssm.blog.controller.home;
...
public class ArticleController {
    ...
    static {
         ...
         */
        XxlConfClient.addListener("default.limit", new XxlConfListener(){
            @Override
    ...
    public String getArticleDetailPage(@PathVariable("articleId") Integer articleId, Model model) {
        String limitConf = XxlConfClient.get("default.limit", "8");
        int limit=Integer.valueOf(limitConf);
        //文章信息，分类，标签，作者，评论
...
//        model.addAttribute("randomArticleList", randomArticleList);
        //获得热评文章
        List<Article> mostCommentArticleList = articleService.listArticleByCommentCount(limit);
        model.addAttribute("mostCommentArticleList", mostCommentArticleList);
        //获得高赞文章
        List<Article> mostLikeArticleList = articleService.listArticleByLikeCount(limit);
