...
import com.ssm.blog.util.GetLeafIDUtil;
import com.ssm.blog.util.RedisDao;
...
public class ArticleServiceImpl implements ArticleService {
    ...
    public void updateArticle(Article article) {
        redisDao.setRedisArticle(article);
        articleMapper.update(article);
    }
...
//            articleList.get(i).setTagList(tagList);
    ...
    public Article getArticleByStatusAndId(Integer status, Integer id) {
        Article article=redisDao.getRedisArticle(id);
...
//        if(!RedisUtil.hasKey("CommentList")){
//            List<Article> articleList=articleMapper.listArticleByCommentCount(limit);
//            for(int i=0;i<limit;i++){
//                RedisUtil.zAdd("CommentList",articleList.get(i).toString(),articleList.get(i).getArticleCommentCount());
//            }
//            return articleList;
//        }
//        else{
...
//        }
    ...
    public List<Article> listArticleByLikeCount(Integer limit) {
        return articleMapper.listArticleByLikeCount(limit);
    }
    ...
    public void insertArticle(Article article) {
        //添加文章
        //添加leaf ID
        String id=GetLeafIDUtil.getLeafID("http://192.168.192.128:8080/api/segment/get/","article-id");
        if(id!="failed"){
